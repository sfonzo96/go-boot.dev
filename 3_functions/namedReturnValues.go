...
// When more contex is needed, return  values can be named in the function's signature, then it works as if variables are already defined in the functions body
